...
export default function NotepadPage() {
  ...
  useEffect(() => { if (legacySeeded) return; const legacy = localStorage.getItem(LEGACY_NOTE_KEY); if (!legacy) return; setLegacySeeded(true); createNote.mutate({ title: "Untitled note", content: legacy }); localStorage.removeItem(LEGACY_NOTE_KEY); }, [legacySeeded]);
